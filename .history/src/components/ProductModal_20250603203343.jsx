...
function ModelViewer({ fileUrl }) {
  ...
  // 点击/触摸结束事件，用于检测双击（桌面）或双 tap（移动端）
  ...
  return (
    <>
      ...
      <div
        ...
        onTouchEnd={handleTouchEnd} // 监听单指 touchend 以检测双 tap
      >
      ...
      {isFullscreen &&
        ReactDOM.createPortal(
          <div
            ...
            onDoubleClick={handleDoubleClick}
            onTouchEnd={handleTouchEnd} // 同样在全屏容器里也监听双 tap
          >
            {isLoading && <div className="loading-overlay">加载中...</div>}
