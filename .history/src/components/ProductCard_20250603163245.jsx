...
function ProductCard({ product, onOpenModal }) {
  ...
  useEffect(() => {
    const handleMouseMove = (e) => {
      ...
      console.log(`perspective(1000px) rotateX(${tilt.x}deg) rotateY(${tilt.y}deg) scale(${tilt.hover ? 1.05 : 1})`);
    };
    ...
    <div className="product-card" ref={cardRef}>
      <div className="card-content">
        ...
        <motion.button
          ...
          style={{
            transform: `perspective(1000px) rotateX(${tilt.x}deg) rotateY(${tilt.y}deg) scale(${tilt.hover ? 1.05 : 1})`,
